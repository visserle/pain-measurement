...
TRIAL = TrialConfig(
    name = 'trial',
    load_columns = ["Time","Timestamp","Stimuli_Seed"],
    notes = ""
)

TEMPERATURE = TrialConfig(
    name = 'temperature',
    load_columns = ["Time","Timestamp","Temperature"],
    plot_columns = ["Temperature"],
)

RATING = TrialConfig(
    name = 'rating',
    load_columns = ["Time","Timestamp","Rating"],
    plot_columns = ["Rating"],
)

EDA = TrialConfig(
    name = 'eda',
    load_columns = ["Time","Timestamp","EDA_RAW","EDA_d_Battery","EDA_d_PacketReceptionRate"],
    plot_columns = ["EDA_RAW"],
)

ECG = TrialConfig(
    name = 'ecg',
    load_columns = ["Time","Timestamp","ECG_LL-RA","ECG_LA-RA","ECG_Vx-RL","ECG_LL-RA_HeartRate","ECG_LL-RA_IBI","ECG_d_Battery","ECG_d_PacketReceptionRate"],
    plot_columns = ["ECG_LL-RA","ECG_LA-RA","ECG_Vx-RL","ECG_LL-RA_HeartRate","ECG_LL-RA_IBI"],
)

EEG = TrialConfig(
    name = 'eeg',
    load_columns = ["Time","Timestamp","EEG_RAW_Ch1","EEG_RAW_Ch2","EEG_RAW_Ch3","EEG_RAW_Ch4","EEG_RAW_Ch5","EEG_RAW_Ch6","EEG_RAW_Ch7","EEG_RAW_Ch8"],
...
SYSTEM = TrialConfig(
    name = 'system',
    load_columns = ["Time","Timestamp","CPU Sys","Memory Sys","CPU Proc","Memory Proc"],
)
...
TRIAL_LIST = [TRIAL, TEMPERATURE, RATING, EDA, ECG, EEG, PUPILLOMETRY, AFFECTIVA, SYSTEM]
