...
class BayesianEstimatorVAS:
    ...
    # Initialization and usage of BayesianEstimatorVAS for VAS 0 and VAS 70.
    ...
    Extensions
    ----------
    - This class can be extended to implement a Kalman filter for more sophisticated estimations.
    ...
    Insights
    --------
    The usual temperature range between pain threshold and pain tolerance is around 4°C. 
    ...
    ----------
    MAX_TEMP : float
        The maximum temperature considered by the estimator, set to 48°C.
